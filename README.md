...
####Version information
This is the latest stable version of FRED. There should not be commits to this branch. For versions prior to 2.9.1, you can download from the FRED Website
