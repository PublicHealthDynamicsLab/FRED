...
public:
   ...
   */
  int get_overall_start_day() const {
    return overall_start_day;
  }
   ...
   */
  Antiviral* get_current_av() const {
   ...
   */
  Antivirals* get_antivirals() const {
   ...
   */
  bool get_are_policies_set() const {
