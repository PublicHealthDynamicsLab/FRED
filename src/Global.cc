...
bool Global::Enable_Household_Isolation = 0;
...
void Global::get_global_parameters() {
  ...
  Params::get_param_from_string("enable_household_isolation", &temp_int);
  Global::Enable_Household_Isolation = (temp_int == 0 ? false : true);
