...
int Place::get_state_fips() {
  if (Global::Places.is_country_usa()) {
    return get_county_fips()/1000;
  }
  if (Global::Places.is_country_india()) {
    return (int) (this->fips/1000000000);
  }
  else {
    return get_county_fips();
  }
}

int Place::get_county_fips() {
  if (Global::Places.is_country_usa()) {
    return (int) (this->fips/1000000);
  }
  if (Global::Places.is_country_india()) {
    return (int) ((this->fips/1000000) % 1000);
  }
  else {
    return (int) this->fips;
  }
}
