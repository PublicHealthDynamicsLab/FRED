...
public: 
   ...
   */
  Neighborhood( const char *lab, fred::place_subtype subtype, fred::geo lon, fred::geo lat, Place *container, Population* pop );

  /**
   * @see Place::get_parameters(int diseases)
   *
   * This method is called by the constructor
   * <code>Neighborhood(int loc, const char *lab, fred::geo lon, fred::geo lat, Place *container, Population* pop)</code>
   */
